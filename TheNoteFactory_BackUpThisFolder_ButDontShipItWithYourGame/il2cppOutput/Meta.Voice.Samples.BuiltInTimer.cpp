...
IL_0019:
	{
		...
		double* L_3 = (&__this->____time_4);
		bool L_4;
		L_4 = TimerController_ParseTime_m0536BAF8BD837F986D16F73793086DFC005F170E(__this, L_2, L_3, NULL);
		V_1 = L_4;
		bool L_5 = V_1;
		if (!L_5)
		{
	...
	}
	{
		...
		TimerController_Log_mA4230F4D69BEC5439F2DEBFC376C5678DCE4EE9A(__this, L_18, NULL);
	}
...
IL_001d:
	{
		...
		StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248* L_2 = ___0_entityValues;
		bool L_3;
		L_3 = TimerController_ParseTime_m0536BAF8BD837F986D16F73793086DFC005F170E(__this, L_2, (&V_0), NULL);
		V_2 = L_3;
		bool L_4 = V_2;
		if (!L_4)
		{
...
IL_0080:
	{
		// Log(msg);
		String_t* L_17 = V_3;
		TimerController_Log_mA4230F4D69BEC5439F2DEBFC376C5678DCE4EE9A(__this, L_17, NULL);
		goto IL_0099;
	}
...
IL_0019:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_11, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&TimerController_ParseTime_m0536BAF8BD837F986D16F73793086DFC005F170E_RuntimeMethod_var)));
	}
